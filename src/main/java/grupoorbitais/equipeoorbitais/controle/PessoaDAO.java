...
public class PessoaDAO {
	/*Explicando o conceito e utilização do Entity Managers:
	 *Os Entity Managers são configurados para serem capazes de persistir ou gerenciar tipos específicos de objetos, ler e 
	 *escreve-los numa base de dados e ser implementado por um Provedor de Persistência (persistence provider) como Hibernate.
	 *Estes provedores são responsáveis por implementar a especificação da Java Persistence API, desde o Entity Manager até geração
	 *de SQL e outras funcionalidades.*/
